...
export default function Home() {
  return (
    <div>
      ...
      <header>
        <h1>Pluriverso Digital</h1>
        <p>La Plataforma Digital sobre Estudios de la Diversidad Cultural en México es un Proyecto financiado por el Programa de Apoyo a Proyectos para la Innovación y Mejoramiento de la Enseñanza PAPIME PE404617.</p>
      </header>
      <main>
        <section>
          <h2>Acerca de Pluriverso</h2>
          <p>La Plataforma Digital sobre Estudios de la Diversidad Cultural en México, a la que hemos llamado Pluriverso DIGITAL, abarca seis ejes relacionados con el estudio de las culturas, la era del reconocimiento a minorías, y las políticas públicas. Estos ejes son: identidad, interseccionalidad, interculturalidad, interculturalismo, multiculturalidad y multiculturalismo.</p>
