  ...
  return (
    <>
      <header className="w-full text-center py-24 imagen-fondo-pluriverso">
        <h1 className="text-7xl text-white font-bold">Pluriverso</h1>
      </header>
        ...
        <section>
          ...
          <Tabs>
            ...
            <TabPanel>
              <section>
                <h2>Descripción</h2>
                <p className="font-medium text-lg text-gray-700">La enseñanza y aprendizaje de la cultura se ha complejizado desde las últimas décadas del siglo XX como resultado del reconocimiento oficial y legal a minorías de distintas identidades. Los pueblos indígenas y afrodescendientes, las identidades sexuales diversas, la articulación de identidades sexuales, con marcadores de raza y etnia, adquieren cada vez mayor visibilidad. Hay cierto ambiente favorable para la expresión de las identidades, ello debido a un activismo consciente, y a sus intelectuales, maestros, poetas, comunicadores, mujeres y hombres, dispuestos a entablar negociación con otros actores y que están contribuyendo a la transformación de los estados-nación. Los estados-nación transitan de una hegemonía monocultural y lingüística, a un reconocimiento de la diversidad. Este reconocimiento no es ideológico, sino que está inscrito en las cartas constitucionales de México, y de muchos otros países. No obstante, su materialización es aún incipiente. Tal reconocimiento ha dado lugar al diseño e implementación de diversas políticas públicas que buscan construir naciones incluyentes, y respetuosas de los derechos humanos, y de las identidades diversas. Las naciones están dejando de ser integracionistas y asimilacionistas para construir sociedades multiculturales e interculturales.</p>
                <p className="font-medium text-lg text-gray-700">En la actualidad, los términos de interculturalidad, interculturalismo, multiculturalidad, multiculturalismo, interseccionalidad e identidad se usan ampliamente en el discurso cotidiano, político, académico, educativo, mediático, diplomático y cultural. Sin embargo, como ocurre frecuentemente, a mayor utilización de estos conceptos, menor claridad sobre sus significados, semejanzas, diferencias o interconexiones. En PLURIVERSO DIGITAL buscamos intervenir de manera innovadora e interactiva en los conceptos aludidos, recurriendo a las actuales redes socio-digitales de información, de comunicación, y del lenguaje audiovisual.</p>
              </section>
            </TabPanel>
            <TabPanel>
              <section>
                <h2>Historia</h2>
                <p className="font-medium text-lg text-gray-700">La idea de PLURIVERSO DIGITAL surgió en el aula de clases. La experiencia docente de la coordinadora por más de 20 años ha puesto como foco de atención, en el proceso enseñanza-aprendizaje, que el estudio de la cultura se ha diversificado, ampliado y complejizado.</p>
                <p className="font-medium text-lg text-gray-700">Ello por lo menos en los siguientes planos epistemológicos y metodológicos: 1. Políticas públicas multiculturales o interculturales, 2. Construcción de identidades, 3. Complejidad de las identidades, por ejemplo, la interseccionalidad (género, raza, etnia, clase, generación). Por lo tanto, se ha producido nacionalmente e importado del extranjero una vasta literatura que contiene diferentes escuelas, autores, geografías, metodologías, entre otros elementos, los cuales prevalecen dispersos. De ahí que el estudio de la cultura esté desorganizado desde el rigor científico. Tal desestructuración ha generado en consecuencia confusión entre conceptos y términos claves, como son: la interculturalidad, el interculturalismo, el multiculturalismo, la multiculturalidad; la construcción de identidades desde el simbolismo, el etno simbolismo, instrumentalismo, esencialismo, el esencialismo estratégico: La interseccionalidad como metodología para el estudio específico de las identidades complejas, junto con los intersticios, espacios entre identidades, son propuestas teóricas desde el sub continente indio, América, y Europa, conocidas a partir de los años ochenta.</p>
              </section>
            </TabPanel>
            <TabPanel>
              <section>
                <h2>Objetivos</h2>
                <p className="font-medium text-lg text-gray-700">Crear un espacio en línea, de acceso abierto y gratuito, a todos los interesados en temas de identidades y culturas.</p>
                <ul className="list-disc">
                  <li className="font-medium text-gray-700 mb-2">Ordenar y sistematizar las fuentes documentales y testimoniales (escritas, sonoras, visuales y audiovisuales) que existen sobre los temas de cultura, reconocimiento, identidades e interseccionalidad, utilizando tecnología de la información.</li>
                  <li className="font-medium text-gray-700 mb-2">Trazar los estados del arte de los ejes de la propuesta, proporcionando: escuelas de pensamiento, autores, aportaciones, geografías, entre otros.</li>
                  <li className="font-medium text-gray-700 mb-2">Construir descripciones de los materiales presentados de manera breve.</li>
                  <li className="font-medium text-gray-700 mb-2">Crear recursos didácticos innovadores en contenido epistemológico y metodológico.</li>
                  <li className="font-medium text-gray-700 mb-2">Aplicar tecnología de la información a los recursos didácticos innovadores.</li>
                  <li className="font-medium text-gray-700 mb-2">Producir materiales audiovisuales, visuales o auditivos (dependiendo de los requerimientos) introductorios y actualizadores en la materia.</li>
                  <li className="font-medium text-gray-700 mb-2">Recabar y presentar los productos generados por los alumnos de la licenciatura, dándoles un espacio en el repositorio.</li>
                  <li className="font-medium text-gray-700 mb-2">Propiciar la retroalimentación a través del foro creado con ese objetivo.</li>
                  <li className="font-medium text-gray-700 mb-2">Articular trabajo de campo propio que indague en casos de identidades complejas a manera de ejemplo y actualización de los temas.</li>
                  <li className="font-medium text-gray-700 mb-2">Generar difusión constante sobre la página en distintos canales, tanto por redes socio-digitales como al extender la invitación a los académicos que imparten asignaturas de ciencias sociales y humanidades, para que tanto ellos como sus alumnos obtengan provecho de la plataforma interactiva.</li>
                </ul>
              </section>
            </TabPanel>
            <TabPanel>
