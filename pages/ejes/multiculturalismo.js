...
export default function multiculturalismo() {
  return (
    <>
      <Head>
        <title>Multiculturalismo | Pluriverso Digital</title>
        <meta charset="utf-8" />
        <meta name="viewport" content="initial-scale=1.0, width=device-width" />
        <meta name="description" content="Eje Multiculturalismo. Pluriverso Digital es la plataforma digital sobre estudios de la diversidad cultural en México que abarca seis ejes relacionados con el estudio de las culturas, la era del reconocimiento a minorías, y las políticas públicas." />
        <link rel="icon" href="/prismaicon.ico" />
      </Head>
      <header className="w-full text-center py-24 imagen-fondo-pluriverso md:py-6">
        <h1 className="text-7xl text-white font-bold md:text-3xl">Multiculturalismo</h1>
      </header>
      <main className="mx-12 md:mx-2">
        ...
        <section>
          ...
          <div className="mb-10 flex justify-center">
            <a target="_blank" rel="noopener noreferrer" href="https://www.goconqr.com/es-MX/p/13979939----Multiculturalismo-mind_maps?frame=true" className="bg-action py-4 px-20 mr-2 rounded-md shadow-lg text-white text-xl font-medium transition duration-300 ease-in-out hover:bg-secondary sm:px-10 sm:text-base md:mr-0 md:mb-2">Ir al mapa mental interactivo</a>
          </div>
          <div className="mb-4">
